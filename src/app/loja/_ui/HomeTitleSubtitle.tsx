...
const HomeTitleSubtitle = ({
  ...
  const css = {
    ...
    h2: `w-full mb-6 font-h font-light text-center text-neutral-500 text-[1.130em] sm:text-[1.136em] md:text-[1.139em] lg:text-[1.144em] xl:text-[1.150em] 2xl:text-[1.156em] cursor-default`,
  };
