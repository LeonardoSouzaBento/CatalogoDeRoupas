...
const css = {
  ...
  wrapperTitle:
    "min-h-10 min-w-full pb-3 mb-2 flex justify-between items-center gap-2 border-b border-gray-300 rounded-none relative",
  button: "h-9 min-w-9 br-xs centralize bg-bt",
