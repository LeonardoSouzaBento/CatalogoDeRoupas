...
const css = {
  wrapper: "min-h-full",
  wrapperInfo: "mb-5 p-3 pb-0 border border-neutral-200",
  h4: "mb-2 font-h text-neutral-700 font-medium h4-sizes",
  p: "mb-2 text-neutral-700",
  li: "small-p font-p ",
  textarea:
    "w-full centralize pt-4 px-4 mb-3 border bg-neutral-100 !border-none rounded-sm box-border focus:outline-none font-p",
  button: "",
};
