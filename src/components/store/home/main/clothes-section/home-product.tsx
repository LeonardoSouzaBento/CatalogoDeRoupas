...
const css = {
  productWrapper: `h-max w-[84vw] max-w-104 md:max-w-108 shrink-0 
  flex flex-col items-end shadow-sm/24 border-shadow select-none
  ...
  grid grid-cols-[1fr_2fr] bp-375:grid-cols-[1fr_1.75fr] sm:grid-cols-[1fr_1.6fr] 
  relative bg-light-bg rounded-none`,
};
