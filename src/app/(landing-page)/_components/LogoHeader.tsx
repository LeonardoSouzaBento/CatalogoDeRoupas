const css = {
  divLogo:
    "w-full h-22 pb-1 bg-stone-800 centralize flex-col relative z-4 rounded-none",
  pLogo:
  ...
  landingPageStyles: "abso bg-stone-950/50",
};
  ...
  return (
    <div
      className={`${css.divLogo} ${
        page === "landing-page" && css.landingPageStyles
      }`}
    >
