...
import { iconMdStyles, iconSmStyles, iconLgStyles } from "@/app/lucideIconStyles";
import "../globals.css"
...
const css = {
  ...
  h1: "text-gray-900 font-semibold capitalize tracking-normal mb-3 text-left text-[1.380em] sm:text-[1.409em] md:text-[1.423em] lg:text-[1.452em] xl:text-[1.480em] 2xl:text-[1.508em]",
  h2: "w-full mb-7 font-light text-left text-neutral-600 text-[1.130em] sm:text-[1.136em] md:text-[1.139em] lg:text-[1.144em] xl:text-[1.150em] 2xl:text-[1.156em] cursor-default",
