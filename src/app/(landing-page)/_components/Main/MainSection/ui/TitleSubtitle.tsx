const TitleSubtitle = () => {
  const css = {
    title: `text-white font-extrabold max-w-120 lg:max-w-130 text-center
      font-p text-[1.800em] sm:text-[1.888em] md:text-[1.930em] 
      lg:text-[2.015em] xl:text-[2.100em] 2xl:text-[2.185em]`,
    subtitle: `text-white text-center max-w-110 lg:max-w-130 
      text-[1.300em] sm:text-[1.388em] md:text-[1.430em] lg:text-[1.515em] xl:text-[1.600em] 2xl:text-[1.685em]`,
