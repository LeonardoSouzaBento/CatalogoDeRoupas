  ...
  return (
    <header className="w-full h-max relative">
      <div
        ...
        <h2 className={`leading-none mb-1 font-logo text-primary-50 font-medium`}>Roupas Online</h2>

        <p className={`leading-none text-primary-50/86 font-light`}>Guardamos suas curtidas</p>
      </div>
    </header>
  );
};
