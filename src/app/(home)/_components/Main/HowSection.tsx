...
const Messages = () => {
  const css = {
    ...
    wrapperPNumber:
      "h-7 min-w-7 flex justify-center items-center rounded-[50%] bg-teal-500",
    pNumber:
    ...
    p: "font-p text-gray-800 font-normal -mt-[1px] text-left text-[1.160em] sm:text-[1.183em] md:text-[1.195em] lg:text-[1.217em] xl:text-[1.240em] 2xl:text-[1.263em]",
  };
