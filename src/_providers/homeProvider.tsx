...
export const HomeDataProvider: React.FC<ProviderType> = ({ children }) => {
  ...
  const [homeEditMode, setHomeEditMode] = useLocalStorage('homeEditMode', false);
  /* Categorias principais */
  const [mainCategories, setMainCategories] = useState<MainCategoriesType>(defaultMainCategories);
  /* Limite de scroll */
  const [scrollLimitSpecialSelections, setScrollLimitSpecialSelections] = useState<number>(0);
