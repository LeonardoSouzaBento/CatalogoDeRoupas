...
const css = {
  ...
  buttonCall:
    `h-13 w-full max-w-86 flex items-center justify-center gap-3 px-6 text-center rounded-2xl bg-yellow-400 text-stone-800 font-p font-semibold leading-5 cursor-pointer hover:bg-yellow-500 transition-color duration-300 
