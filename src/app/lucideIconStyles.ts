...
/* estilos */
export const iconSmStyles = { strokeWidth: 2.3, size: 17, color: gray800 };
export const iconMdStyles = { strokeWidth: 2.2, size: 19.5, color: gray800 };
export const iconLgStyles = { strokeWidth: 2.1, size: 21, color: gray800 };
