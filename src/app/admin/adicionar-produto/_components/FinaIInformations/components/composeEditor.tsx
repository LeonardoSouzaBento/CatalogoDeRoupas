...
const Materials: React.FC<MaterialsProps> = ({
  ...
  const css = {
    ...
    title: `p16 font-medium mb-3 uppercase text-blue-600 tracking-wide`,
  ...
  return (
    <WrapperOptions styles={css.container} title="Selecione o material">
      <div
        ref={ref}
        className={`${css.wrapperButtons} ${
          seeCommonFabrics && "ring ring-blue-300 p-0.5 pb-0"
        }`}
      >
...
const SearchMaterial = ({
  ...
  const css = {
    ...
    input: `w-full p185 pl-4 pr-6 br-0`,
  };
...
const CompositionEditor = () => {
  ...
  return (
    <div>
      ...
      <WrapperButtons
        grid={true}
        styles={`p-5 grid grid-cols-1 sm575:grid-cols-2 gap-4`}
      >
        <SearchMaterial
