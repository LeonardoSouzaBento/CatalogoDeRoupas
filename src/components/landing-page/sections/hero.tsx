...
const css = {
  ...
  wrapper: `max-w-176 mx-auto bp-930:max-w-none xl:max-w-274 grid grid-cols-1 gap-6 
  bp-930:grid-cols-2`,
  messageWrapper: "w-full flex flex-col justify-center items-center",
  imageContainer: `h-full relative bp-930:pt-10`,
  ...
  secondImgWrapper: `h-full hidden bp-576:block`,
};
